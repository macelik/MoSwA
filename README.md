...
used as a quantitative measure of protein sequence diversity, applied via a user-defined k-mer sliding window. The entropy value of a given k-mer position in a sequence
